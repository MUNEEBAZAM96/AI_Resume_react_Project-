...
export default function Home() {
   return <main className="bg-[url('/images/bg-main.svg')] bg-cover">
    <Navbar />
       <section className=" mt-10 main-section bg-gradient-to-b from-light-blue-100 to-light-blue-200">
       ...
       {resumes.length > 0 && (
        <section className="resumes-section mt-10 grid grid-cols-1 gap-6  py-6 px-6 pb-10 md:grid-cols-2 lg:grid-cols-3">
          {resumes.map((resume) => (
